...
<body>
    ...
    <div class="text-box-1 relative back-white">
    ...
    <div class="prod-slide back-white flex con-min-width">
        ...
        <div class="intro relative flex-1-0-0 flex-jc-end">
            <div class="text-box">
                ...
                <div class="nth-child-5">자세히 보기</div>
                <div class="prod-slide-mini flex">
                    <div class="size-120"
                        style="background-image:url(https://kima-rin.github.io/img1/pf/Bon/bnr_202006300934383S9.png)">
                    </div>
                    <div class="size-120"
                        style="background-image:url(https://kima-rin.github.io/img1/pf/Bon/bnr_20200630093036jkk.png)">
                    </div>
                    <div class="size-120"
                        style="background-image:url(https://kima-rin.github.io/img1/pf/Bon/bnr_20200529165741RXc.jpg)">
                    </div>
                    <div class="size-120"
                        style="background-image:url(https://kima-rin.github.io/img1/pf/Bon/bnr_202005221115275eB.jpg)">
                    </div>
                </div>
            </div>
        </div>
        <div class="prod-slide-middle relative flex-1-0-0">
            <div class=""
                style="background-image:url(https://kima-rin.github.io/img1/pf/Bon/bnr_202006300934387BR.png)">
            </div>
        </div>
    </div>
