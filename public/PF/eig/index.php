...
<head>
    ...
    <title>eightthethalasso.jp</title>
    <!--폰트어썸 불러오기-->
...
<body>
    ...
    <section>
        <div class="text-box-1 flex active-on-visible">
            ...
            <div>
                <div class="text-style-1">タラソ幹細胞成分で、ぷるん髪。<br>スキンケア発想のヘアケアブランド。</div>
                <div class="text-style-2"></div>
                <div class="text-style-3">それは、“洗う保水美容液”。<br>最先端のスキンケア技術をかけ合わせて生まれた<br>新発想のヘアケアブランドです。</div>
            </div>
        </div>
    </section>
    <section>
    ...
    <section>
        <div class="third-img-box">
            <div class="relative">
                <div class="text-style-1">潤いの、究極へ。<br>ダメージによるパサつきを、浸透補修。</div>
                <div class="text-style-2"></div>
                <div class="text-style-3">幹細胞や海洋由来の美容成分をブレンドした
                    <br>「タラソ幹細胞成分」を配合。<br>ダメージによるパサつきやうねりに悩む髪を浸透補修し、<br>内側からぷるんと潤う、しっとりとした艶髪へ。</div>
            </div>
            <div class="img-box-1">
                <div></div>
            </div>
    ...
    <div class="pre con">
        <p>
            ※1　クリスマムマリチマムカルス培養液（保湿）［エイトザタラソ モイストヘアオイル、エイトザタラソ スムースヘアオイル以外に配合］　※2　クリスマムマリチマムカルス培養液（保湿）［エイトザタラソ
            モイストヘアオイル、エイトザタラソ スムースヘアオイル以外に配合］/アルガニアスピノサカルス培養エキス(保湿）［エイトザタラソ
            モイストトリートメントに配合］／リンゴ果実培養細胞エキス(保湿）／ブドウ果実細胞エキス（保湿）［エイトザタラソ モイストシャンプー、エイトザタラソ
            プレシャンプーに配合］／エリンギウムマリチムムカルス培養液（保湿）［エイトザタラソ スムースシャンプー、 エイトザタラソ スムーストリートメントに配合］</p>
    </div>
    <div class="footer">
        <img src="http://eightthethalasso.jp/_nuxt/img/8251501.svg" alt="">
        <div>
        ...
        <div>ステラシード株式会社 〒107-0061 東京都港区北青山3-5-25表参道ビル4階 Tel.03-6804-5584 info@stellaseed.jp</div>
        <div>©2019 8 THE THALASSO, All Rights Reserved.</div>
    </div>
