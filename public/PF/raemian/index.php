...
<body>
<div class="top-bar flex con-min-width">
     <div class="background"></div>
     <div class="con flex">
         <div class="flex-ai-c">
             <div class="btn-toggle-mobile-side-bar flex-1-0-0">
                 <div></div>
                 <div></div>
                 <div></div>
             </div>
         ...
         <ul class="flex flex-1-0-0">
             ...
             <li><a href="#" class="block">래미안타임즈</a>
                 <ul>
         ...
         <div class="logo flex-1-0-0 flex-jc-c flex-ai-c"><img src="https://raemian.co.kr/assets/front/inc/images/layout/logo_h.png" alt=""></div>
         <ul class="flex flex-1-0-0">
             <li><a href="#" class="block">분양안내</a>
                 <ul>
             ...
             <li><a href="#" class="block">계약·입주서비스</a>
                 <ul>
         ...
         <div class="icon-box-1 flex flex-1-0-0 flex-jc-end flex-ai-c">
             <a href="#"><img src="https://raemian.co.kr/assets/front/inc/images/layout/btn_h_calendar.png" alt=""></a>
             <a href="#"><img src="https://raemian.co.kr/assets/front/inc/images/layout/btn_h_mymenu.png" alt=""></a>
         </div>
     </div>
 </div>
